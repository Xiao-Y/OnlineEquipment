...
public class Reporting extends BaseEntity implements Serializable {
	 ...
	 * 
	 * @author XiaoY
	 * @date: 2016年5月1日 上午11:28:33
	 */
	private static final long serialVersionUID = -382100980778095034L;
	/* 申报故障信息id */
	...
	public String toString() {
		return "Reporting [reportingUuid=" + reportingUuid + ", reportingPhone=" + reportingPhone + ", orderTime="
				+ orderTime + ", priorCode=" + priorCode + ", devicePicUrl=" + devicePicUrl + ", account=" + account
				+ ", remark=" + remark + ", reportingTime=" + reportingTime + ", user=" + user + ", deviceState="
				+ deviceState + ", toString()=" + super.toString() + "]";
	}
}
