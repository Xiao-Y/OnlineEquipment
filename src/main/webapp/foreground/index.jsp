...
<html>
		...
		<div class="navbar">
			<div class="navbar-inner">
				<div class="container-fluid">
					...
					<a class="brand" href="index.html"><span>设备故障申报系统</span></a>
					...
					<div class="nav-no-collapse header-nav">
						<ul class="nav pull-right">
							...
							<li class="dropdown">
								<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
									<i class="halflings-icon white user"></i> Billow
	...
	<footer>
		<p>
			<span style="text-align:left;float:left">&copy; 2015 <a href="https://github.com/Xiao-Y/OnlineEquipment" alt="OnlineEquipment 设备故障申报系统">OnlineEquipment 设备故障申报系统</a></span>
		</p>
	</footer>
